...
.auth {
  ...
  background: linear-gradient(155deg, #0f1117 0%, #1a1a24 45%, #1e1d2f 100%);
  position: relative;
}
...
.orb-a {
  ...
  background: radial-gradient(circle, rgba(91,95,227,.25) 0%, transparent 70%);
  top: -180px; right: -100px;
  animation: drift 14s ease-in-out infinite;
}
.orb-b {
  width: 380px; height: 380px;
  background: radial-gradient(circle, rgba(91,95,227,.18) 0%, transparent 70%);
  bottom: -140px; left: -80px;
  animation: drift 18s ease-in-out infinite reverse;
}
.orb-c {
  width: 260px; height: 260px;
  background: radial-gradient(circle, rgba(91,95,227,.12) 0%, transparent 70%);
  top: 50%; left: 50%;
...
.btn {
  ...
  background: #5b5fe3; border: none; border-radius: 12px;
