...
.auth {
  ...
  background: linear-gradient(155deg, #fce4d6 0%, #fdf2f8 45%, #f0e6ff 100%);
  position: relative;
}
...
.orb-a {
  ...
  background: radial-gradient(circle, rgba(232,125,139,.25) 0%, transparent 70%);
  top: -180px; right: -100px;
  animation: drift 14s ease-in-out infinite;
}
.orb-b {
  width: 380px; height: 380px;
  background: radial-gradient(circle, rgba(232,125,139,.18) 0%, transparent 70%);
  bottom: -140px; left: -80px;
  animation: drift 18s ease-in-out infinite reverse;
}
.orb-c {
  width: 260px; height: 260px;
  background: radial-gradient(circle, rgba(232,125,139,.12) 0%, transparent 70%);
  top: 50%; left: 50%;
...
.btn {
  ...
  background: #e87d8b; border: none; border-radius: 12px;
